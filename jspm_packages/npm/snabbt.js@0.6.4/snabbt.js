...
(function(f) {
  ...
  return (function e(t, n, r) {
    ...
    1: [function(require, module, exports) {
      (function(globals) {
        ...
        var find = function(predicate) {
          ...
          var length = list.length < 0 ? 0 : list.length >>> 0;
          if (length === 0)
            return undefined;
    ...
    4: [function(require, module, exports) {
      'use strict';
      var stateFromOptions = require('./state').stateFromOptions;
      var Animation = require('./animation');
      var createState = require('./state').createState;
      var utils = require('./utils');
      var Engine = {
        runningAnimations: [],
        completedAnimations: [],
    ...
    5: [function(require, module, exports) {
      ...
      var preprocessOptions = require('./properties').preprocessOptions;
      var utils = require('./utils');
      var createMatrix = require('./matrix');
      var updateElementTransform = require('./utils').updateElementTransform;
      function snabbt(elements, arg2, arg3) {
        ...
        var aggregateChainer = {
          ...
          finish: function finish(callback) {
            chainers.forEach(function(chainer, index) {
              if (utils.isFunction(callback))
                return chainer.finish(function() {
          ...
          rollback: function rollback(callback) {
            chainers.forEach(function(chainer, index) {
              if (utils.isFunction(callback))
                return chainer.rollback(function() {
                  callback(index, chainers.length);
                });
              chainer.rollback();
            });
    ...
    8: [function(require, module, exports) {
      ...
      var fromPrefixed = require('./properties').fromPrefixed;
        ...
        var API = {
          clone: function clone() {
            ...
            Object.keys(props).forEach(function(property) {
              ...
              if (_this[property])
                clonedConfig[property] = type === types.SCALAR ? _this[property] : _this[property].slice(0);
            });
